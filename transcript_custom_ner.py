...
def main():
   ...
   # Getting the pipeline component
    ...
    TRAIN_DATA = [
              ...
              ("wait whats going on again", {"entities": []}),
              ("im confused", {"entities": []}),
              ...
              ("like that thats fair", {"entities": []}),
              ("thats a butt", {"entities": []}),
              ("its a person", {"entities": []}),
              ("oh yeah theres a persons", {"entities": []}),
